...
class CommentFormView(generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        comment.save()
        return redirect('journal:journal_detail', pk=journal_pk)
...
def comment_approve(request, pk):
    ...
    comment.approve()
    return redirect('journal:journal_detail', pk=comment.journal.pk)
...
class ReplyFormView(generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        reply.save()
        return redirect('journal:journal_detail', pk=reply.comment.journal.pk)
